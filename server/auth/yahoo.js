...
const callbackURL = (process.env.NODE_ENV === 'development') ? 'https://f4332861.ngrok.io' : 'https://rm-node-postgres.herokuapp.com'
...
router.get('/callback',
  passport.authenticate('oauth2', { session: false, failureRedirect: '../../failed' }),
  function (req, res) {
